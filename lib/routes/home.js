...
module.exports = function (app) {
  app.get('/', util.ensureLoggedIn(), getHome);
  app.post('/login', util.ensureLoggedIn(), postLogin);
  app.get('/config', util.ensureLoggedIn(), getConfig);
  app.post('/config', util.ensureLoggedIn(), postConfig);
  app.post('/logout/:connectionId', util.ensureLoggedIn(), postLogout);
};
