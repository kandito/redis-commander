...
module.exports = function (app) {
  app.get('/', middleware.ensureLoggedIn, getHome);
  app.post('/login', middleware.ensureLoggedIn, postLogin);
  app.get('/config', middleware.ensureLoggedIn, getConfig);
  app.post('/config', middleware.ensureLoggedIn, postConfig);
  app.post('/logout/:connectionId', middleware.ensureLoggedIn, postLogout);
};
...
function getConfig (req, res) {
  req.app.getConfig(function (err, config) {
    ...
    var defaultConnections = _.chain(config).get('default_connections').map('label').value();
    _.set(config, 'default_connections', defaultConnections);
